...
export default function getCurrentModal(containerId?: string): {
    id: number;
    events: Record<string, import("../utils/Modal").EventCallback[]>;
    closed: any;
    ...
    containerId: string;
    close: () => Promise<void>;
    onclose: import("../utils/types").GuardFunction;
    readonly instance: import("../utils/types").ModalComponentInterface;
    on: (eventName: string, callback: import("../utils/Modal").EventCallback) => () => void;
} | undefined;
